...
const Operation = () => (
  <div>
        ...
        <tbody className="align-baseline">
          <tr>
            ...
            <td className="p-2 border-t border-gray-300 text-xs">
              ...
              <span className="font-louis">louis</span>, including this list of
          ...
          <tr>
            ...
            <td className="p-2 border-t border-gray-300 text-xs">
              ...
              <br />
              TODO fancy 'example' style?
              <i>Example</i>: if you are in the Learn app and wish to close it,
              you would say <span className="italic underline">exit</span> or{" "}
              <span className="italic underline">quit</span> to go back to the
              main menu.
            </td>
          </tr>
          <tr>
            ...
            <td className="p-2 border-t border-gray-300 text-xs">
              Hear a list of voice command options. In the main menu, this gives
            ...
            <td className="p-2 border-t border-gray-300 text-xs">
              ...
              <br />
              <i>Example</i>: if a yes-no question has just been asked, it will
              return the options <span className="italic underline">yes</span>{" "}
    ...
    <p>
      TODO fancy quote style? If this is your first time opening{" "}
      <span className="font-louis">louis</span>, then you will also hear:
      <br />
      "You can get more information and instructions by saying{" "}
      <span className="italic underline">help</span>.<br />
      You can quit <span className="font-louis">louis</span> and apps at any
      time by saying <span className="italic underline">quit</span> or{" "}
      <span className="italic underline">exit</span>.<br />
      You can hear your voice command options by saying{" "}
      <span className="italic underline">options</span>.<br />
      You can change settings by saying{" "}
      <span className="italic underline">settings</span>."
    </p>
    ...
    <p>
      When you are in the main menu, you will hear the phrase: "You can now open
      any application using voice command". You can then open any application of{" "}
    ...
    <p>
      You can hear your voice command options by saying{" "}
      <span className="italic underline">options</span>. While in the main menu,{" "}
      <span className="italic underline">options</span> will give you the list
      of apps installed. In a specific app,{" "}
    ...
    <p>
      If you are using an app that requires you to read multiple words or lines
      of a text, you can scroll to the next line by pressing the button on the
      last cell. If you wish to move to the previous line, then press the button
      of the first cell.
    </p>
