  ...
  return (
    <div>
      ...
      <p>
        ...
        <code>App</code>. When your class is instantiated by the app loader on
        the braille device, you will have access to useful instance variables
        and methods that allow you to design your very own app flow.
      </p>
      <p>
        For ease of development, the code is portable between the Raspberry Pi
        with Arduino PCBs (which the braille device works with) and
        computer-only testing. Thus you are not required to have a device in
        order to build your own apps. You can switch to Python terminal
        interaction by setting the variable <code>main_cell</code> to{" "}
        <code>comp</code> instead of <code>arduino</code> in the file{" "}
        <code>src/app_states/main_state.txt</code>. You can run{" "}
        <code>python3 src/main.py</code> once you have installed all the
        packages <span className="font-louis">louis</span> depends on, which can
        be found in the <code>requirements.txt</code> file. The terminal will
        prompt you for the number of cells you want to work with, and when
        relevant, prompt you for the button cell index you want to press.
      </p>
      <p>
        ...
        can turn on and turn off audio output by setting{" "}
        <code>output_audio</code> to <code>true</code>
        and <code>false</code>, respectively. The output will always be printed
        to the terminal. You can turn on and turn off speech input by setting
      ...
      <p>
        ...
        braille device (modularity). <code>Cell</code> contains methods that
        allow you to interact with a specific braille cell without having to
        deal with the low-level hardware code.
      </p>
        ...
        <table className="w-full text-left">
          ...
          <tbody className="align-baseline">
            ...
            <tr>
              ...
              <td className="p-2 border-t border-gray-300 text-xs">
                Waits and returns <code>True</code> when the user presses the
                button on the cell.
              </td>
            </tr>
            <tr>
      ...
      <p>
        Your app receives an instance of <code>Audio</code> which provides
        methods to interact with the microphone and speakers, as well as
        utilities for speech recognition and synthesis. These functions are
        essential for the user experience as blind users starting to learn
        braille heavily rely on audio.
      </p>
      <div className="my-6 border-t border-b border-gray-300 overflow-hidden relative">
        <table className="w-full text-left">
          <thead>
      ...
      <p>
        If you would like the <code>Audio</code> output to be your own mp3
        recording, upload the file in the <code>src/cache</code> folder with the
        md5 hash of the output as filename.
      </p>
      <h3 id="direct">
        <code>Direct</code>
      </h3>
        ...
        <table className="w-full text-left">
          ...
          <tbody className="align-baseline">
            ...
            <tr>
              ...
              <td className="p-2 border-t border-gray-300 text-xs">
                Development helper function that prints the current output on
                the cells to the terminal, including the normal alphabet
                character underneath the braille cells.
              </td>
            </tr>
            <tr>
              <td className="p-2 border-t border-gray-300 font-mono text-xs text-purple-700">
            ...
            <tr>
              ...
              <td className="p-2 border-t border-gray-300 text-xs">
                Listens for audio input, waits for one of the desired responses
                to be said and returns that option.
              </td>
            </tr>
            <tr>
              <td className="p-2 border-t border-gray-300 font-mono text-xs text-purple-700">
      ...
      <p>
        <code>self.settings</code> contains a dictionary of previously stored
        app settings from the file system. You can add the settings you need for
        your app to the file <code>[appname]_state.txt</code> in the{" "}
        <code>src/app_states</code> folder. If the setting is user-editable,
        create a key <code>editable</code> which is a dictionary containing the
        editable settings. Provide a name, description, current value and a
        dictionary of possible values with their description.
      </p>
    </div>
  )
}
